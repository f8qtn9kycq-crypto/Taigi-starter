  ...
  },
  {
    ...
    phrases: [
      ...
      makePhrase({
        ...
        tailo: "Tsia̍h io̍h-á",
        poj: null,
        meaning: { zh: "吃藥；服用藥物", en: "take medicine" },
        cultureNote: {
          zh: "教育部「藥仔」詞條以 tsia̍h io̍h-á 作為例句；本課只教表達，不替使用者判斷是否需要用藥。",
          en: "The MOE entry for io̍h-á uses tsia̍h io̍h-á as an example; teach the expression only and do not advise whether someone should take medicine.",
        },
  ...
  },
  {
    ...
    phrases: [
      ...
      makePhrase({
        ...
        tailo: "Tsē tshia",
        poj: null,
        meaning: { zh: "搭乘車輛", en: "ride in a vehicle" },
        cultureNote: {
          zh: "教育部「坐」的交通義項直接以「坐車」為用例；本課把它當成出門方式，不延伸到複雜交通分類。",
          en: "The MOE entry for tsē uses tsē tshia as its transport example; this lesson treats it as one simple way to travel.",
        },
