...
- Release source commit: `23a9700dda5e1ee7fdde133ed79dc41dc337a8ed`
- Sites saved version: `14`
- Sites saved source: `23a9700dda5e1ee7fdde133ed79dc41dc337a8ed`
- Production URL: https://taigi-start.alexcy2025.chatgpt.site
- Version 14 deployment: `appgdep_6a655b2e964881919372034ff8d86165`, succeeded; env revision `5`
...
| Live API security smoke | Pass | Version 14 live config returned the Google Form URL with `no-store`; valid same-origin POST returned 410 `external_feedback_only`, export returned 410, `/feedback` returned 404, evil Origin returned 403, and unsupported content type returned 415 |
