...
| T10 | P0 | Truthful scope | Inspect lesson and course progress. | The release candidate says Lessons 1–18 are available, shows the current lesson's real phrase count, and does not claim completed lessons or unsupported phrase counts. |
