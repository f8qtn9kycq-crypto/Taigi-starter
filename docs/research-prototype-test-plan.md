...
| T10 | P0 | Truthful scope | Inspect lesson and course progress. | The UI says Lessons 1–15 are available, shows the current lesson's real phrase count, and does not claim completed lessons or unsupported phrase counts. |
